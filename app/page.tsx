...
export default function Home() {
  return (
    <div className="container mx-auto px-4 py-12 min-h-screen flex flex-col">
      <h1 className="text-2xl md:text-3xl lg:text-4xl font-bold mb-8 text-center text-primary">Welcome to San Jose Municipal Health</h1>
      <p className="text-xl text-center mb-12 text-muted-foreground">Your one-stop solution for managing appointments.</p>
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
        <Card className="transform transition-all hover:scale-105 bg-background shadow-none">
          <CardHeader>
            ...
            <CardDescription>Schedule your next visit or medical test</CardDescription>
          </CardHeader>
          <CardContent>
            <Link href="/book">
